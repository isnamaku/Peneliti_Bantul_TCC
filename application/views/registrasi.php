            ...
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('registrasi/index'); ?>" class="user">
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Nama Lengkap..." name="nama" value="<?= set_value('nama'); ?>">

                  <?php echo form_error('nama', '<div class = "text-danger small ml-2">', '</div>'); ?>
                </div>    

                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Username..." name="username" value="<?= set_value('username'); ?>">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="Nohp" placeholder="Nomor HP..." name="nohp" value="<?= set_value('nohp'); ?>">
